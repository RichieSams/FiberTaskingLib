...
2.2+|                                                                                                                                                                                                                                                                                                    | Clang 3.7 | image:https://dev.azure.com/adastley/adastley/_apis/build/status/RichieSams.FiberTaskingLib?api-version=6.0-preview.1&label=build&branchName=master&job=linux_clang_37[Linux Clang 3.7 build status, link="https://dev.azure.com/adastley/adastley/_build?definitionId=1"]  2+|
